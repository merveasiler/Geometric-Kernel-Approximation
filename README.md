...
**Sample I/O:**  You can test the ```EXE/wringer.off``` input mesh file with the default settings to obtain the results presented in Table 1 and Fig. 5 of the paper. 
